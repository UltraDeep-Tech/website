...
export function BackgroundEffects({ variant = 'section', intensity = 'medium' }: BackgroundEffectsProps) {
  ...
  return (
    <div className="absolute inset-0 overflow-hidden pointer-events-none">
      ...
      {/* Light theme mesh gradient - más visible */}
      <motion.div
        className="absolute inset-0 opacity-0 [data-theme='light']:opacity-20 hidden [data-theme='light']:block"
        animate={{
          background: [
            'radial-gradient(circle at 20% 30%, rgba(99, 102, 241, 0.15) 0%, transparent 50%), radial-gradient(circle at 80% 70%, rgba(99, 102, 241, 0.12) 0%, transparent 50%), radial-gradient(circle at 50% 50%, rgba(139, 92, 246, 0.10) 0%, transparent 50%)',
            'radial-gradient(circle at 80% 30%, rgba(99, 102, 241, 0.12) 0%, transparent 50%), radial-gradient(circle at 20% 70%, rgba(139, 92, 246, 0.15) 0%, transparent 50%), radial-gradient(circle at 50% 50%, rgba(99, 102, 241, 0.10) 0%, transparent 50%)',
            'radial-gradient(circle at 50% 20%, rgba(139, 92, 246, 0.12) 0%, transparent 50%), radial-gradient(circle at 30% 80%, rgba(99, 102, 241, 0.10) 0%, transparent 50%), radial-gradient(circle at 70% 60%, rgba(139, 92, 246, 0.08) 0%, transparent 50%)',
            'radial-gradient(circle at 20% 30%, rgba(99, 102, 241, 0.15) 0%, transparent 50%), radial-gradient(circle at 80% 70%, rgba(99, 102, 241, 0.12) 0%, transparent 50%), radial-gradient(circle at 50% 50%, rgba(139, 92, 246, 0.10) 0%, transparent 50%)',
          ],
        }}
        transition={{
      ...
      {(variant === 'section' || variant === 'hero' || variant === 'accent') && (
        <>
          ...
          />
          {/* Light theme grid - más visible */}
          <motion.div
            className="absolute inset-0 opacity-0 [data-theme='light']:opacity-[0.12] hidden [data-theme='light']:block"
            style={{
              backgroundImage: `
      ...
      {/* Connection Lines - Efecto de conexión profesional */}
      ...
      {variant !== 'minimal' && (
        <>
          <motion.div
            className="absolute rounded-full blur-3xl hidden sm:block [data-theme='light']:opacity-100"
            style={{
              width: '400px',
              height: '400px',
          ...
          />
          {/* Light theme glow orbs - más visibles */}
          <motion.div
            className="absolute rounded-full blur-3xl hidden sm:block opacity-0 [data-theme='light']:opacity-100"
            style={{
              width: '400px',
              height: '400px',
              background: `radial-gradient(circle, rgba(99, 102, 241, ${glowIntensity * 1.2}) 0%, transparent 70%)`,
              left: '5%',
              top: '15%',
            }}
            animate={{
          ...
          />
          {/* Light theme glow orb 2 */}
          <motion.div
            className="absolute rounded-full blur-3xl hidden sm:block opacity-0 [data-theme='light']:opacity-100"
            style={{
              width: '350px',
              height: '350px',
              background: `radial-gradient(circle, rgba(139, 92, 246, ${glowIntensity * 1.0}) 0%, transparent 70%)`,
              right: '10%',
              bottom: '20%',
            }}
            animate={{
          ...
          />
          <motion.div
            className="absolute rounded-full blur-3xl hidden md:block [data-theme='light']:opacity-100"
            style={{
              width: '300px',
              height: '300px',
          ...
          />
          {/* Light theme glow orb 3 */}
          <motion.div
            className="absolute rounded-full blur-3xl hidden md:block opacity-0 [data-theme='light']:opacity-100"
            style={{
              width: '300px',
              height: '300px',
              background: `radial-gradient(circle, rgba(99, 102, 241, ${glowIntensity * 0.8}) 0%, transparent 70%)`,
              left: '50%',
              top: '5%',
            }}
            animate={{
          ...
          {variant === 'accent' && (
            <motion.div
              className="absolute rounded-full blur-3xl hidden lg:block"
              style={{
                width: '250px',
                height: '250px',
                background: `radial-gradient(circle, rgba(139, 92, 246, ${glowIntensity * 0.5}) 0%, transparent 70%)`,
      ...
      {(variant === 'hero' || variant === 'section') && (
        <>
          <motion.div
            className="absolute border border-indigo-500/10 [data-theme='light']:border-indigo-500/20 rounded-lg hidden lg:block"
            style={{
              width: '200px',
              height: '200px',
              left: '15%',
          ...
          />
          <motion.div
            className="absolute border border-violet-500/10 [data-theme='light']:border-violet-500/20 rounded-full hidden lg:block"
            style={{
              width: '150px',
              height: '150px',
              right: '20%',
      ...
      {/* Enhanced Animated Grid Pattern - Más profesional */}
      {variant === 'hero' && (
        <>
          <motion.div
      ...
      {/* Professional Shimmer Effect - Más sutil */}
      <motion.div
      ...
      {/* Data Flow Lines - Líneas de flujo de datos profesionales */}
      {variant === 'hero' && (
        <svg className="absolute inset-0 w-full h-full opacity-[0.08]" style={{ zIndex: 0 }}>
          <defs>
